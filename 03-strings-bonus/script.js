...
const cityIndex = cityName.indexOf("y") + 1 ;   // e' giusto + 1?
...
const cityNameConcat = `${(city.concat(" ", cityName))}`;   // e giusto l' uso di `${var}` o c'e un altro metodo? e se giusto a quale funzione sarebbe utile quest' uso?
